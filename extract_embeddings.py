...
os.makedirs('batch_hard_triplet_loss50_softplus', exist_ok = True)
...
hf_gallery = h5py.File('batch_hard_triplet_loss50_softplus/gallery_embeddings.h5', 'w')
hf_query = h5py.File('batch_hard_triplet_loss50_softplus/query_embeddings.h5', 'w')
...
model = EmbeddingNet()
checkpoint = torch.load('checkpoints_market1501_batchhard_softplus/model_epoch_50.pth')
