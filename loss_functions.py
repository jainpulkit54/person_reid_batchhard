...
def triplet_loss(emb_anchor, emb_positive, emb_negative, margin = 0.2):
...
def batch_hard_online_triplet_loss(labels, embeddings, margin = 0.2, squared = False):
	...
	fraction_positive_loss_triplets = num_positive_loss_triplets/triplet_loss.shape[0]
...
def batch_all_online_triplet_loss(labels, embeddings, margin = 0.2, squared = False):
